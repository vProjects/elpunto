...
<div id="dashboard">
	<div id="mailbox" style="height:1300px">
        ...
        <form class="meta_tag" action="v-includes/functions/function_verticalMenu/function.insert_verticalmenu.php" method="get">
        	<label class="label1" style="margin-right:0px;">Menu Name:</label><input type="text" class="input1" name="menu_name" placeholder="Enter Menu Name" style="width: 200px; margin-right:30px;" id="v_menu_name" onblur="categoryLink('v_menu_name','v_menu_link')">
            <label class="label1" style="margin-right:0px;">Menu Link:</label><input type="text" class="input1" name="menu_link" placeholder="Enter Menu Link" style="width: 200px; margin-right:30px;" id="v_menu_link">
        ...
        <form class="meta_tag" action="v-includes/functions/function_verticalMenu/function.insert_verticalsubmenu.php" method="get">
        	...
        	<label class="label1" style="margin-right:0px;">Sub Menu Name:</label><input type="text" class="input1" name="submenu_name" placeholder="Enter Menu Name" style="width: 200px; margin-right:30px;" id="v_submenu_name" onblur="categoryLink('v_submenu_name','v_submenu_link')">
            <label class="label1" style="margin-right:0px;">Sub Menu Link:</label><input type="text" class="input1" name="submenu_link" placeholder="Enter Menu Link" style="width: 200px; margin-right:30px;" id="v_submenu_link">
            <?php if(isset($result)) echo $result ?>
            <button type="submit" class="btn btn-primary" onClick="" style="float:right;margin-right: 42px;">Create</button> 
        </form>
